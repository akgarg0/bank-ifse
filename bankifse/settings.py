"""
Django settings for bankifse project.
...
SECRET_KEY = '^)%a*wfb%5n(uxzt7&_gl*mdkjjfpi-b9qqqt=6l+&ozac+wl0'
...
WSGI_APPLICATION = 'bankifse.wsgi.application'
